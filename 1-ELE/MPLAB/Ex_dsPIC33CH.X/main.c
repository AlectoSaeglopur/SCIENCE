...
/* FSEC register */
#pragma config BWRP = 1 //0                                             /* Set boot segment as not write-protected */
#pragma config BSS = 2                                              /* Set no boot segment code flash protection (other than BWRP) */
#pragma config BSEN = 1                                             /* Set no boot segment */
#pragma config GWRP = 1//0                                             /* Set general segment as not write-protected */
#pragma config GSS = 3 //0                                              /* Set no general segment code flash protection (other than GWRP) */
#pragma config CWRP = 1 //0                                             /* Set configuration segment as not write-protected */
#pragma config CSS = 7 //6                                              /* Set no configuration segment code flash protection (other than CWRP) */
...
#pragma config CPRA3 = SLV1                                         /* Assign pin RA3 to Slave core : VI1 */
#pragma config CPRA4 = SLV1                                         /* Assign pin RA4 to Slave core : VI2 */
...
#pragma config CPRB14 = SLV1                                        /* Assign pin RB14 to Slave core : EXTR3 */
#pragma config CPRB15 = SLV1                                        /* Assign pin RB15 to Slave core : EXTR1 */
...
#pragma config CPRC7 = SLV1                                         /* Assign pin RC7 to Slave core : VI4 */
...
#pragma config CPRD10 = SLV1                                        /* Assign pin RD10 to Slave core : VI3 */
...
/** FCFGPRE0 */
#pragma config CPRE0 = MSTR                                         /* Assign pin RE0 to Slave core : EXTR2 */
...
#pragma config CPRE11 = SLV1                                        /* Assign pin RE11 to Master core : FEEL_B */
#pragma config CPRE12 = MSTR                                        /* Assign pin RE12 to Master core : RC_TRIP */
#pragma config CPRE13 = SLV1                                        /* Assign pin RE13 to Slave core : SOA_TRIP */
...
/** FPOR register */
#pragma config BISTDIS = 0                                          /* Enable MBIST feature on reset for Master core */
#pragma config S1BISTDIS = 0                                        /* Enable MBIST feature on reset for Slave core */
...
/**
 * @brief <i> Function to initialize Master internal PLL network for boosting Master's FRC input clock to maximum 90 MIPS (FCY = 90 MHz, FPPLO = 360 MHz) and peripheral registers. </i>
 */
void Init_Clock( void ){
