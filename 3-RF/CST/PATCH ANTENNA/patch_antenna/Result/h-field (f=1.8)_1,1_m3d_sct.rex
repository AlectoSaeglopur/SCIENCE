...
<MetaResultFile creator="Modeler" version="20140129">
  ...
  <SimulationProperties excitationpower="0.5" fieldtype="H-Field (peak)" frequency="1.799999952316" unit="A/m"/>
  ...
  <ResultGroups num_steps="1">
    <Frame index="0">
      <FieldResultFile filename="h-field (f=1.8)_1,1.m3d" meshname="" type="m3d"/>
    </Frame>
  </ResultGroups>
