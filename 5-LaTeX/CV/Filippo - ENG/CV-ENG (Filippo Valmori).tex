...
Engaged within the food-preparation field, as part of the R\&D team, in the embedded firmware development of kitchen appliances (especially ovens, induction hobs and hoods), in particular with tasks concerning:
\begin{itemize}
  \item[$\cdot$] embedded firmware programming of 32-bit ARM Cortex-M0$+$ and -M7 microcontrollers for power and user-interfaces boards, with special focus on UI graphical design based on Figma/Zeplin;
...
Engaged within the power electronics field, as part of the R\&D team, in the embedded hardware and firmware development of domotic, industrial and  automotive safety devices, in particular with tasks concerning:
\begin{itemize}
...
Engaged within the aerospace field in the DSP and radio-frequency (RF) development of shared and distributed \textit{ground station} services, in particular with tasks concerning:
\begin{itemize}
...
Engaged within the aerospace field in the design and development of digital and RF electronic systems for \textit{smallsat} platforms in cooperation with the \textit{European Space Agency} (ESA), in particular with tasks concerning:
\begin{itemize}
