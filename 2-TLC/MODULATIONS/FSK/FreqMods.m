...
dev = 1.3e3;                                            % Inner frequency deviation [Hz]
...
% [Symbs,Nsymbs] = GenUpktSitael('uHET');                                       % Retrieve U-packet symbols from ESEO or uHETsat mission
...
% BuiltIn = mskmod((Symbs+1)/2,osf);
% figure
% plot(TimeBB*1e3,real(BuiltIn),'b.-',TimeBB*1e3,imag(BuiltIn),'r.-')
% xlabel('Time [ms]'); ylabel('Amplitude [V]'); axis([0 1 1.2*[-1 1]]); grid on
% title('MATLAB BUILT-IN MSK WAVEFORM'); legend(' In-phase',' Quadrature')
...
subplot(2,2,1)
stem(0:Nsymbs*osf-1,GfskPcmPh/(2*pi),'.','Color',Orange)
...
% % function [ Symbs, Nsymbs ] = GenUpktSitael( Mission )
% %     
% %     switch Mission
% %         case 'ESEO'
% %             Upkt = ['55';'55';'55';'55';'55';'55';'55';'55';'7E';'7E'; ...
% %                     'D3';'EC';'03';'A8';'BA';'B1';'23';'CB';'12';'83'; ...
% %                     '8A';'3E';'49';'32';'2E';'81';'50';'00';'8A';'1B'; ...
% %                     '4B';'75';'54';'E9';'A9';'CD';'91';'F7';'EA';'A1'; ...
% %                     'AA';'77';'BF';'25';'7E';'7E';'22';'22'];
% %         case 'uHET'
% %             Upkt = ['AA';'AA';'AA';'AA';'AA';'AA';'AA';'AA';'D3';'91'; ...
% %                     'D3';'91';'21';'5A';'04';'B9';'FA';'95';'FD';'44'; ...
% %                     '0E';'11';'A8';'A6';'92';'81';'CF';'52';'47';'25'; ...
% %                     'CA';'EE';'9D';'0A';'A7';'2F';'57';'BB';'85';'E6'; ...
% %                     'F1';'A3';'B4';'4A';'35';'33';'22';'22'];
% %         otherwise
...
% %     Symbs = 2*Symbs-1;
% %     Nsymbs = length(Symbs);
% %     if strcmp(Mission,'uHET')
% %         Symbs = -Symbs;           % NB: Mapping inversion to match CC1101 features (only uHET mission)
% %     end
% % 
% % end
% % 
% % 
% % %%% --> Function for converting input hexadecimal bytes into corresponding
% % %%%     binary value
