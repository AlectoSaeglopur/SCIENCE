...
# Title: Test Psk Mapper 2
# Generated: Fri Aug 26 11:16:02 2022
##################################################
...
class test_psk_mapper_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Test Psk Mapper 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test Psk Mapper 2")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_psk_mapper_2")
        ...
        # Blocks
        ##################################################
        self.zVKN_psk_mapper_p_mm_0 = zVKN.psk_mapper_p_mm(4, 45, True)
...
def main(top_block_cls=test_psk_mapper_2, options=None):
