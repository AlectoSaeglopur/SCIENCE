...
L81:
	...
	movl	$LC25, %eax
L84:
	.loc 1 364 0 discriminator 8
	movl	%eax, 4(%esp)
	movl	$LC26, (%esp)
	call	_printf
	.loc 1 365 0 is_stmt 1 discriminator 8
	movl	12(%ebp), %eax
	movzbl	4(%eax), %eax
	movzbl	%al, %eax
	movl	%eax, 4(%esp)
...
L88:
	...
	movl	$LC33, (%esp)
	call	_printf
	.loc 1 370 0 is_stmt 1 discriminator 8
	movl	$LC34, (%esp)
	call	_printf
...
L92:
	...
	movl	$LC37, (%esp)
	call	_printf
	.loc 1 372 0 is_stmt 1 discriminator 8
	movl	$LC38, (%esp)
	call	_printf
	.loc 1 373 0 discriminator 8
	movl	12(%ebp), %eax
	movl	64(%eax), %eax
	testl	%eax, %eax
	jne	L93
...
LFB27:
	...
	movl	%ebx, %edx
	movl	12(%ebp), %ecx
	movl	%eax, _gWatermarks(,%ecx,8)
	movl	%edx, _gWatermarks+4(,%ecx,8)
	jmp	L152
L151:
	.loc 1 622 0
	movl	$17, -12(%ebp)
...
L156:
	...
	movzbl	-9(%ebp), %eax
	movl	_gWatermarks+4(,%eax,8), %edx
	movl	_gWatermarks(,%eax,8), %eax
	movl	%eax, %edx
	movzbl	-9(%ebp), %eax
	addl	$1, %eax
	movl	%edx, 8(%esp)
