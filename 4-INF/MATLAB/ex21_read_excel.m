...
Fname = 'ex21_english.xlsx';                                                        % Input Excel file name
Nw = 10;                                                                            % Number of words / expression to be asked
Type = 'VER';                                                                       % Tab selector (ADJ, ADV, NOU, VER, EXP or SEN)
Mode = 'ITA';                                                                       % Mode selector (ENG, PRN, ITA, EXE)

if strcmp(Type,'ADJ')
    ShId = 1;
    Table = readtable(Fname,'ReadVariableNames',false,'Sheet',ShId);
