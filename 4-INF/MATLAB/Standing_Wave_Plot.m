...
SimMode = 'PLOT';                       % Simulation mode (choose GIF or PLOT)
...
for i = 1:osf
    ...
    SgnFwd = [SgnFwd(end) SgnFwd(1:end-1)];         % Update the forward wave
    SgnRef = [SgnRef(2:end) SgnRef(1)];             % Update the reflected wave
