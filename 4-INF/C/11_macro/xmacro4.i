...
#pragma pack(pop)
# 284 "c:\\mingw\\x86_64-w64-mingw32\\include\\_mingw.h" 2 3 4
...
# 506 "c:\\mingw\\x86_64-w64-mingw32\\include\\corecrt.h" 3 4
#pragma pack(pop)
...
# 86 "ex_xmacros_4.c"
enum {
  LAYOUT_IDX_Z3, LAYOUT_IDX_Z4, LAYOUT_IDX_Z5,
  LAYOUT_IDX_MAX
};
# 105 "ex_xmacros_4.c"
typedef enum view_enum {
  VIEW_IDX_AAA, VIEW_IDX_BBB, VIEW_IDX_CCC, VIEW_IDX_DDD,
  VIEW_NUM_MAX
} view_t;
# 133 "ex_xmacros_4.c"
...
{
  uint32_t btn_widget;
  uint32_t img_widgets[5];
  
# 137 "ex_xmacros_4.c" 3 4
 _Bool 
# 137 "ex_xmacros_4.c"
      is_active;
} tab_t;
...
{
  [VIEW_IDX_AAA][LAYOUT_IDX_Z3].btn_widget = 0xA83, [VIEW_IDX_AAA][LAYOUT_IDX_Z4].btn_widget = 0xA84, [VIEW_IDX_AAA][LAYOUT_IDX_Z5].btn_widget = 0xA85, [VIEW_IDX_BBB][LAYOUT_IDX_Z3].btn_widget = 0xB83, [VIEW_IDX_BBB][LAYOUT_IDX_Z4].btn_widget = 0xB84, [VIEW_IDX_BBB][LAYOUT_IDX_Z5].btn_widget = 0xB85, [VIEW_IDX_CCC][LAYOUT_IDX_Z3].btn_widget = 0xC83, [VIEW_IDX_CCC][LAYOUT_IDX_Z4].btn_widget = 0xC84, [VIEW_IDX_CCC][LAYOUT_IDX_Z5].btn_widget = 0xC85, [VIEW_IDX_DDD][LAYOUT_IDX_Z3].btn_widget = 0xD83, [VIEW_IDX_DDD][LAYOUT_IDX_Z4].btn_widget = 0xD84, [VIEW_IDX_DDD][LAYOUT_IDX_Z5].btn_widget = 0xD85,
  [VIEW_IDX_AAA][LAYOUT_IDX_Z3].img_widgets = {0xA930, 0xA931, 0xA932}, [VIEW_IDX_AAA][LAYOUT_IDX_Z4].img_widgets = {0xA940, 0xA941, 0xA942, 0xA943}, [VIEW_IDX_AAA][LAYOUT_IDX_Z5].img_widgets = {0xA950, 0xA951, 0xA952, 0xA953, 0xA954}, [VIEW_IDX_BBB][LAYOUT_IDX_Z3].img_widgets = {0xB930, 0xB931, 0xB932}, [VIEW_IDX_BBB][LAYOUT_IDX_Z4].img_widgets = {0xB940, 0xB941, 0xB942, 0xB943}, [VIEW_IDX_BBB][LAYOUT_IDX_Z5].img_widgets = {0xB950, 0xB951, 0xB952, 0xB953, 0xB954}, [VIEW_IDX_CCC][LAYOUT_IDX_Z3].img_widgets = {0xC930, 0xC931, 0xC932}, [VIEW_IDX_CCC][LAYOUT_IDX_Z4].img_widgets = {0xC940, 0xC941, 0xC942, 0xC943}, [VIEW_IDX_CCC][LAYOUT_IDX_Z5].img_widgets = {0xC950, 0xC951, 0xC952, 0xC953, 0xC954}, [VIEW_IDX_DDD][LAYOUT_IDX_Z3].img_widgets = {0xD930, 0xD931, 0xD932}, [VIEW_IDX_DDD][LAYOUT_IDX_Z4].img_widgets = {0xD940, 0xD941, 0xD942, 0xD943}, [VIEW_IDX_DDD][LAYOUT_IDX_Z5].img_widgets = {0xD950, 0xD951, 0xD952, 0xD953, 0xD954},
  [VIEW_IDX_AAA][LAYOUT_IDX_Z3].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_AAA][LAYOUT_IDX_Z4].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_AAA][LAYOUT_IDX_Z5].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_BBB][LAYOUT_IDX_Z3].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_BBB][LAYOUT_IDX_Z4].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_BBB][LAYOUT_IDX_Z5].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_CCC][LAYOUT_IDX_Z3].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 1
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_CCC][LAYOUT_IDX_Z4].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 1
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_CCC][LAYOUT_IDX_Z5].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 1
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_DDD][LAYOUT_IDX_Z3].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_DDD][LAYOUT_IDX_Z4].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
# 147 "ex_xmacros_4.c"
 , [VIEW_IDX_DDD][LAYOUT_IDX_Z5].is_active = 
# 147 "ex_xmacros_4.c" 3 4
 0
...
void debug_table_content(const tab_t *table, uint8_t zone_num)
{
  ...
  printf(" ----------\n");
  printf(" >> ACT     = %s\n",(table->is_active == 0 ? "FALSE" : "TRUE"));
  printf(" ----------\n");
}

void debug_table_size(const tab_t *table)
{
  size_t size8b = sizeof(*table);
  size_t size32b = sizeof(*table);
  printf(" >> Size = %d B = %d W\n", size8b,
...
int main(void)
{
  ...
  uint8_t my_nzones = 5;
  tab_t my_table = all_icons_tables[my_view][my_nzones-(uint8_t [LAYOUT_IDX_MAX]){3, 4, 5}[0]];
  debug_table_content(&my_table,my_nzones);
  debug_table_size(&my_table);
  return 1;
}
