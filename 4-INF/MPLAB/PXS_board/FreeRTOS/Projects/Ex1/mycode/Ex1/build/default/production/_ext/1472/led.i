...
void Blink_LED0( void *pvParameters ){
    ...
    while( 1 ){
        vTaskDelay(( ( TickType_t) ( ( ( TickType_t) ( 5 ) )) * ((( TickType_t) ( ( TickType_t ) 1000 ) ) / ( TickType_t) 1000 )));
...
void Blink_LED1( void *pvParameters ){
    ...
    while( 1 ){
        vTaskDelayUntil(&xLastWakeTime, ( ( TickType_t) ( ( ( TickType_t) ( 17 ) )) * ((( TickType_t) ( ( TickType_t ) 1000 ) ) / ( TickType_t) 1000 )));
        Toggle_GPIO(GpioId);
    }
}
