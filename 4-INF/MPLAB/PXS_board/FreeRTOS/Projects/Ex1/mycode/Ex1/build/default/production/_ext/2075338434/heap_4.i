...
# 1 "<command-line>"
# 1 "../../source/portable/MemMang/heap_4.c"
# 78 "../../source/portable/MemMang/heap_4.c"
...
# 79 "../../source/portable/MemMang/heap_4.c" 2
...
# 86 "../../source/portable/MemMang/heap_4.c" 2
...
# 87 "../../source/portable/MemMang/heap_4.c" 2
...
# 125 "../../source/portable/MemMang/heap_4.c"
...
static const size_t xHeapStructSize = ( sizeof( BlockLink_t ) + ( ( size_t ) ( 2 - 1 ) ) ) & ~( ( size_t ) ( 0x0001 ) );
...
void *pvReturn = 0;
 ...
 ( void ) xTaskResumeAll();
# 300 "../../source/portable/MemMang/heap_4.c"
 ;
 return pvReturn;
}
...
size_t uxAddress;
size_t xTotalHeapSize = ( ( size_t ) 5120 );


 uxAddress = ( size_t ) ucHeap;

 if( ( uxAddress & ( 0x0001 ) ) != 0 )
 {
  uxAddress += ( 2 - 1 );
  uxAddress &= ~( ( size_t ) ( 0x0001 ) );
