...
# 79 "../../source/portable/MemMang/heap_1.c" 2
...
# 86 "../../source/portable/MemMang/heap_1.c" 2
...
# 87 "../../source/portable/MemMang/heap_1.c" 2
...
void *pvPortMalloc( size_t xWantedSize ){
 ...
 vTaskSuspendAll();
 {
  if( pucAlignedHeap == 0 ){
   ...
   pucAlignedHeap = ( uint8_t * ) ( ( ( uint32_t ) &ucHeap[ 2 ] ) & ( ~( ( uint32_t ) ( 0x0001 ) ) ) );

  }


  if( ( ( xNextFreeByte + xWantedSize ) < ( ( ( size_t ) 5120 ) - 2 ) ) &&
