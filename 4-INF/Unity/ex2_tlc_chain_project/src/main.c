...
int main(){
	...
	PrintByt(TxSrcByt,SrcBytLen,PRID_TXINFOB);											/** Print TX source info stream on terminal */
	...
	PrintByt(RxSrcByt,SrcBytLen,PRID_RXINFOB);											/** Print RX source info stream on terminal */
	CheckWrongBits(TxSrcByt,RxSrcByt,SrcBytLen,PRID_RXINFOB);							/** Check number of corrupted bits after convolutional decoding */
