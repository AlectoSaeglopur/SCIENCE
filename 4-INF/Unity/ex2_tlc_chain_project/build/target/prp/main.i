...
_Bool 
# 54 "src\\extra.h"
    CheckWrongBits( uint8_t *Stream_A, uint8_t *Stream_B, uint32_t Len, uint8_t Label );
...
int main(){
 ...
 RandBytGen(TxSrcByt);
 PrintByt(TxSrcByt,(uint32_t)100,PRID_TXINFOB);
 ...
 if ( (uint8_t)13u == (uint8_t)13u ){
  ...
  CheckWrongBits(TxConvByt,DemByt,(uint32_t)((uint32_t)100*((uint8_t)2 +1)/(uint8_t)2),PRID_RXCCB);
 ...
 CheckWrongBits(TxSrcByt,RxSrcByt,(uint32_t)100,PRID_RXINFOB);
